...
function MyComponent({ }) {
  ...
  React.useEffect(() => {
    ...
    fetch('http://localhost:8080/api/eventRead')
    ...
    render() {
      ...
      return (
        <g>
          ...
          <image x={x - 50} y={newY - 50} width="100" height="100" alt={datum.pic} xlinkHref={process.env.PUBLIC_URL + datum.pic} loading="lazy"/>
        </g>
      );
    }
  }
